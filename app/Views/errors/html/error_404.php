          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2>SORRY!</h2>
                <h3 class="font-weight-light">Cannot seem to find the page you were looking for.</h3>
              </div>
            </div>
            <div class="row mt-5">
            ...
            <div class="row mt-5">
              <div class="col-12 mt-xl-2">
                <p class="text-white font-weight-medium text-center">© 2023 <a href="https://www.instagram.com/kitsuzu.store" target="_blank">Kitsuzu Store</a> All Rights Reserved.</p>
              </div>
            </div>
          </div>
        </div>
