                <div class="main-panel">
                    <div class="content-wrapper">
                        ...
                        <form action="/Buku/create_buku/" method="post" enctype="multipart/form-data">
                            
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="card" style="width: 18rem;">
                                        <img class="card-img-top" id="image-preview" src="<?= base_url('assets/images') ?>/cinta_brontosaurus.jpg">
                                        <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" name="judul_buku" id="judul_buku">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="pengarang_buku">Pengarang buku</label>
                                                    <input type="text" class="form-control form-control-sm" name="pengarang_buku" id="pengarang_buku">
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" name="penerbit_buku" id="penerbit_buku">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="Tahun_buku">Tahun buku</label>
                                                    <input type="text" class="form-control form-control-sm" name="tahun_buku" id="Tahun_buku">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="tebal_buku">Tebal buku</label>
                                                    <input type="text" class="form-control form-control-sm" name="tebal_buku" id="tebal_buku">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="source_buku">Source buku</label>
                                                    <input type="url" class="form-control form-control-sm" name="source_buku" id="source_buku">
                                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <textarea class="form-control" name="orientasi_buku" id="orientasi_buku" rows="10" cols="30"></textarea>
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="tafsiran_buku">Tafsiran buku</label>
                                                    <textarea class="form-control" name="tafsiran_buku" id="tafsiran_buku" rows="10" cols="30"></textarea>
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="evaluasi_buku">Evaluasi buku</label>
                                                    <textarea class="form-control" name="evaluasi_buku" id="evaluasi_buku" rows="10" cols="30"></textarea>
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="rangkuman_buku">Rangkuman buku</label>
                                                    <textarea class="form-control" name="rangkuman_buku" id="rangkuman_buku" rows="10" cols="30"></textarea>
                                                </div>
